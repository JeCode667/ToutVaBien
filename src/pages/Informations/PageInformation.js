    ...
    <div>
      <div className="info-container">
        ...
        <div className="section">
          ...
          <p>
            Découvrez les ressources et aides disponibles pour vous. Vous n'êtes
            pas seul.
          </p>
        </div>
        ...
        <div className="section">
          ...
          <p>
            Si vous êtes confronté(e) à des situations de violence, il existe
            des services spécialisés pour vous aider.
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Associations locales :</strong> Contactez les Maisons des
              Adolescents pour un espace sûr et de l'écoute.
            </li>
          </ul>
          <p>
        ...
        <div className="section">
          ...
          <ul>
            <li>
              <strong>Numéro national 3020 :</strong> Ligne dédiée pour les
              jeunes victimes de harcèlement scolaire.
            </li>
            <li>
              <strong>Net-Écoute :</strong> Appelez le <strong>3018</strong> ou
              visitez{" "}
              <a
            ...
            <li>
              <strong>Adultes à l'écoute :</strong> Parlez à un prof, CPE ou un
              adulte de confiance.
            </li>
          </ul>
          <p>
        ...
        <div className="section">
          ...
          <p>
            Si ça ne va pas, voici des pistes pour trouver du soutien et des
            solutions.
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Psychologue ou infirmière scolaire :</strong> Parlez-en
              avec un pro pour des conseils adaptés.
            </li>
          </ul>
          <p>
        ...
        <div className="section">
          <h3>Addictions</h3>
          <p>
            Si tu te sens dépendant(e) aux écrans, substances ou autre, voici de
            l’aide :
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Éducateurs spécialisés :</strong> Ils t’accompagnent pour
        ...
        <div className="section">
          ...
          <p>
            Si tu te poses des questions sur toi-même, des ressources sont
            disponibles :
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Groupes de parole :</strong> Rejoins des espaces pour
              échanger avec d’autres jeunes.
            </li>
          </ul>
        </div>
      </div>
