      ...
      <div className="info-container">
        ...
        <div className="section">
          ...
          <p>
            ...
            services spécialisés pour vous aider.
          </p>
          <ul>
            <li>
              <strong>SOS Violences :</strong> Appelez le <strong>3919</strong> pour obtenir de l’aide et des conseils.
            </li>
            <li>
              <strong>Enfance en Danger :</strong> Appelez le <strong>119</strong> pour signaler une situation dangereuse.
            </li>
            <li>
        ...
        <div className="section">
          ...
          <p>
            Le harcèlement peut être dur à vivre, que ce soit à l’école ou en ligne. Il existe des aides utiles :
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              <a href="https://www.net-ecoute.fr" target="_blank" rel="noopener noreferrer">
                Net-Écoute
              </a>{" "}
              pour signaler un harcèlement en ligne.
            </li>
            <li>
        ...
        <div className="section">
          ...
          <ul>
            <li>
              <strong>Fil Santé Jeunes :</strong> Appelez le <strong>0800 235 236</strong> ou consultez leur site.
            </li>
            <li>
              <strong>Applis bien-être :</strong> Essayez des applis comme <em>Calm</em> ou <em>Petit Bambou</em>.
            </li>
            <li>
        ...
        <div className="section">
          ...
          <ul>
            <li>
              <strong>Drogues Info Service :</strong> Appelez le <strong>0800 23 13 13</strong>.
            </li>
            <li>
              <strong>Applications :</strong> Utilisez <em>Forest</em> ou <em>Offtime</em> pour limiter le temps d’écran.
            </li>
            <li>
        ...
        <div className="section">
          ...
          <ul>
            <li>
              <strong>SOS Homophobie :</strong> Appelez le <strong>01 48 06 42 41</strong>.
            </li>
            <li>
              <strong>Le Refuge :</strong>{" "}
              <a href="https://www.le-refuge.org" target="_blank" rel="noopener noreferrer">
